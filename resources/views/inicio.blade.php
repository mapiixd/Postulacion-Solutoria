...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 917px;">
            ...
            <section class="content" style="padding-top: 20px">
                ...
                @yield('content')
                @if(!empty($successMsg))
                    <div class="alert alert-success"> Datos ingresados correctamente a la base de datos</div>
                @endif
            </section>
            <!-- /.content -->
        </div>
  ...
  crossorigin="anonymous"></script>    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script>
